/* globals scheduler, changeURL */

window.addEventListener('DOMContentLoaded', function() {
  var bodyStyles = window.getComputedStyle(document.body);
  var expandedHeight =
    parseInt(bodyStyles.getPropertyValue('--expanded-url-height'));
  ...
  function currentScroll() {
    ...
    if (leftPos < 50 && (currentHistoryPosition === null ||
    ...
    if (leftPos > window.innerWidth - 50 &&
        (currentHistoryPosition === null || currentHistoryPosition < 1)) {
